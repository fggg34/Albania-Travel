<x-app-layout>
    ...
    {{-- Hero bar --}}
    <div class="bg-[#0f1a1a] py-10 px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto flex items-center gap-5">
            <div class="w-14 h-14 rounded-2xl bg-[#0D9488]/20 border border-[#0D9488]/30 flex items-center justify-center flex-shrink-0">
                <i class="fa-solid fa-user text-[#0D9488] text-xl"></i>
            </div>
            <div>
                <p class="text-xs font-semibold text-teal-400 uppercase tracking-widest mb-1">Account Settings</p>
    ...
    <div class="bg-gray-50 min-h-screen py-10 px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                    <div class="w-8 h-8 rounded-lg bg-[#0D9488]/10 flex items-center justify-center">
                        <i class="fa-solid fa-id-card text-[#0D9488] text-sm"></i>
                    </div>
                    <div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                    <div class="w-8 h-8 rounded-lg bg-[#0D9488]/10 flex items-center justify-center">
                        <i class="fa-solid fa-lock text-[#0D9488] text-sm"></i>
                    </div>
                    <div>
