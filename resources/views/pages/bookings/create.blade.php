        ...
        <form action="{{ route('bookings.store') }}" method="POST" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="first_name" id="first_name" value="{{ old('first_name', auth()->user()?->name ? explode(' ', auth()->user()->name, 2)[0] : '') }}" required
                                class="w-full rounded-lg border-gray-300 shadow-sm focus:border-amber-500 focus:ring-1 focus:ring-amber-500 text-gray-900">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input type="email" name="guest_email" id="guest_email" value="{{ old('guest_email', auth()->user()?->email) }}" required
                                class="w-full rounded-lg border-gray-300 shadow-sm focus:border-amber-500 focus:ring-1 focus:ring-amber-500 text-gray-900" placeholder="your@email.com">
                ...
                <div class="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
                    ...
                    <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="billing_country" id="billing_country" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-amber-500 focus:ring-1 focus:ring-amber-500 text-gray-900">
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                    ...
                    <textarea name="special_requests" id="special_requests" rows="3" placeholder="Dietary requirements, accessibility needs, etc." class="w-full rounded-lg border-gray-300 shadow-sm focus:border-amber-500 focus:ring-1 focus:ring-amber-500 text-gray-900">{{ old('special_requests') }}</textarea>
                    @error('special_requests')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                </div>

                <button type="submit" class="w-full lg:w-auto lg:min-w-[280px] py-4 px-6 bg-amber-600 text-white font-semibold rounded-xl hover:bg-amber-700 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 transition">
                    Complete booking
                </button>
            </div>
