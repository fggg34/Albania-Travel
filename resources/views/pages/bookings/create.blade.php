...
<div class="bg-white border-b border-gray-100">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center gap-4">
        <a href="{{ route('tours.show', $tour->slug) }}" class="flex items-center gap-2 text-sm text-gray-500 hover:text-[#CC1021] transition">
            <i class="fa-solid fa-arrow-left text-xs"></i>
            Back to tour
        </a>
        <span class="text-gray-200">|</span>
        <nav class="flex items-center gap-2 text-xs text-gray-400">
            <span class="text-[#CC1021] font-semibold">1. Your details</span>
        ...
        <form action="{{ route('bookings.store') }}" method="POST" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                        <div class="w-8 h-8 rounded-lg bg-[#CC1021]/10 flex items-center justify-center">
                            <i class="fa-solid fa-user text-[#CC1021] text-sm"></i>
                        </div>
                        <div>
                ...
                <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                        <div class="w-8 h-8 rounded-lg bg-[#CC1021]/10 flex items-center justify-center">
                            <i class="fa-solid fa-location-dot text-[#CC1021] text-sm"></i>
                        </div>
                        <div>
                ...
                <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                        <div class="w-8 h-8 rounded-lg bg-[#CC1021]/10 flex items-center justify-center">
                            <i class="fa-solid fa-comment-dots text-[#CC1021] text-sm"></i>
                        </div>
                        <div>
                    ...
                    <div class="p-6">
                        <textarea name="special_requests" id="special_requests" rows="3"
                            ...
                            class="w-full rounded-xl border-gray-200 shadow-sm focus:border-[#CC1021] focus:ring-1 focus:ring-[#CC1021] text-gray-900 text-sm py-2.5 px-3 resize-none">{{ old('special_requests') }}</textarea>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 py-2">
                    <div class="flex flex-wrap gap-4 text-xs text-gray-500">
                        <span class="flex items-center gap-1.5">
                            <i class="fa-solid fa-shield-halved text-[#CC1021]"></i> Secure booking
                        </span>
                        <span class="flex items-center gap-1.5">
                            <i class="fa-solid fa-bolt text-[#CC1021]"></i> Instant confirmation
                        </span>
                        <span class="flex items-center gap-1.5">
                            <i class="fa-solid fa-headset text-[#CC1021]"></i> 24/7 support
                        </span>
                    </div>
                    <button type="submit"
                        class="flex-shrink-0 inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-[#CC1021] text-white font-semibold rounded-xl hover:bg-[#a50d18] transition shadow-sm text-sm">
                ...
                <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden sticky top-24">
                    ...
                    <div class="p-5 space-y-4">
                        ...
                        <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                            ...
                            <span class="text-xl font-bold text-[#CC1021]">€{{ number_format($total, 0) }}</span>
                        </div>
