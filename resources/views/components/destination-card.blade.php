...
@endphp
<a href="{{ $cityUrl }}" class="flex-shrink-0 w-[165px] sm:w-[180px] lg:w-[230px] block group" data-slider-card>
    ...
    <h3 class="mt-2 text-center font-medium text-gray-900 group-hover:text-amber-600 transition-colors">{{ $city->name }}</h3>
</a>
