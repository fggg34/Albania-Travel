...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .btn { display: inline-block; padding: 12px 24px; background: #b45309; color: #ffffff !important; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 14px; margin-top: 8px; }
