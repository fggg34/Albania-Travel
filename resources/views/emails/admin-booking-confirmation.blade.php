...
<table class="email-table">
    ...
    <tr class="detail-row">
        ...
        <td class="detail-value"><a href="mailto:{{ $booking->guest_email }}" style="color: #b45309;">{{ $booking->guest_email }}</a></td>
    </tr>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin-top: 20px; padding: 20px; background: #fef3c7; border-radius: 12px; border-left: 4px solid #f59e0b;">
    <tr>
