# Albania Travel by Sonila Kosta – Tour Agency Web Application
...
5. **Run**
   ...
   npm run dev
   ```
   Open `http://localhost:8000`. Admin: `http://localhost:8000/_panel` (login: admin@albaniatravelbysonilakosta.com / password). Override with `FILAMENT_ADMIN_PATH` in `.env` (e.g. `admin`).
...
- **Admin:** admin@albaniatravelbysonilakosta.com / password  
