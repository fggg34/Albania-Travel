    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
                ...
                <p class="text-sm"><?php echo e(\App\Models\Setting::get('site_tagline', 'Discover your next adventure')); ?></p>
            </div>
            <div>
                <h3 class="text-white font-semibold text-lg mb-4">Contact</h3>
                <p class="text-sm"><?php echo e(\App\Models\Setting::get('contact_email', '')); ?></p>
                <p class="text-sm"><?php echo e(\App\Models\Setting::get('contact_phone', '')); ?></p>
                <p class="text-sm"><?php echo e(\App\Models\Setting::get('contact_address', '')); ?></p>
            </div>
            <div>
