...
<article class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
    <a href="<?php echo e(route('blog.show', $post->slug)); ?>" class="block">
        ...
        <div class="p-4">
            <p class="text-xs text-gray-500"><?php echo e($post->published_at?->format('d M Y')); ?></p>
            <h3 class="mt-1 text-lg font-semibold text-gray-900 line-clamp-2"><?php echo e($post->title); ?></h3>
            <p class="mt-2 text-sm text-gray-600 line-clamp-2"><?php echo e(Str::limit(strip_tags($post->excerpt ?? ''), 120)); ?></p>
        </div>
    </a>
</article>
