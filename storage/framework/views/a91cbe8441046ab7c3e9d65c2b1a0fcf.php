    ...
    <nav x-data="{ open: false }" class="bg-white">
        ...
        <div x-show="open" x-cloak class="lg:hidden border-t border-gray-200 bg-white">
            <div class="pt-2 pb-3 space-y-1 px-4">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="block px-4 py-2 text-base font-medium text-teal-600">Login</a>
                    <a href="<?php echo e(route('register')); ?>" class="block px-4 py-2 text-base font-medium text-teal-600">Register</a>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
    </nav>
