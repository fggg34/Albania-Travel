...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['action' => route('tours.index'), 'cities' => collect()]));
...
foreach (array_filter((['action' => route('tours.index'), 'cities' => collect()]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="w-full max-w-4xl mx-auto" x-data="heroSearchForm({
    ...
    cities: <?php echo \Illuminate\Support\Js::from($citiesData)->toHtml() ?>,
    initialCity: <?php echo \Illuminate\Support\Js::from($initialCity)->toHtml() ?>,
    initialDate: <?php echo \Illuminate\Support\Js::from($initialDate)->toHtml() ?>,
    initialAdults: <?php echo e($initialAdults); ?>,
})" x-init="init()">
...
<?php /**PATH /Users/kevinhitaj/Desktop/Projects/TOURS Second/resources/views/components/hero-search-form.blade.php ENDPATH**/ ?>